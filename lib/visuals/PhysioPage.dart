...
class PhysioPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return PhysioPageState();
  }
}

String _namePhysio = "Harry Osborn";
String _physioCompany = "GoblinMovements Enschede\nShoulder Expert";

class PhysioPageState extends State<PhysioPage> {
